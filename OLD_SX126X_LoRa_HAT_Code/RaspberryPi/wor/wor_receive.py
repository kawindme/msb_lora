...
'''
    ...
    0xC2    0x00  0x09   0x00 0x00 0x00 0x62 0x00 0x12 0x03 0x00 0x00
...
470MHz
CFG_REG = [b'\xC2\x00\x09\x00\x00\x00\x62\x00\x3C\x03\x00\x00']
RET_REG = [b'\xC1\x00\x09\x00\x00\x00\x62\x00\x3C\x03\x00\x00']

868MHz
CFG_REG = [b'\xC2\x00\x09\x00\x00\x00\x62\x00\x12\x03\x00\x00']
RET_REG = [b'\xC1\x00\x09\x00\x00\x00\x62\x00\x12\x03\x00\x00']

915MHz
CFG_REG = [b'\xC2\x00\x09\x00\x00\x00\x62\x00\x41\x03\x00\x00']
RET_REG = [b'\xC1\x00\x09\x00\x00\x00\x62\x00\x41\x03\x00\x00']
